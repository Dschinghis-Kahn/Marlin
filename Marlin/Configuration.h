...
#define STRING_CONFIG_H_AUTHOR "Matthias Walthart" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DSK-3D-Printer"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.2, -7.5, -1.5 }
